...
const SidePanel: React.FC<SidePanelProps> = ({ activeSection, setActiveSection, onLogoutClick }) => {
    const menuItems = [
        ...
        { id: "report", label: "Report", icon: ArrowRightLeft },
        ...
        <div className="w-72 h-screen bg-slate-900/50 backdrop-blur-xl border-r border-white/5 flex flex-col">
            ...
            <div className="p-6 border-b border-white/5">
                <h1 className="text-2xl font-bold text-white">
                    Employee <span className="text-[var(--apl-cyan)]">Portal</span>
                </h1>
                <p className="text-xs text-slate-500 mt-1 uppercase tracking-wider">Stock Management</p>
            </div>
